...
You may supply a Panel of Normal (PON) reference `.cnn` file for use with [CNVkit](https://cnvkit.readthedocs.io/en/stable/index.html) using the `--pon_cnn` parameter.
...
<details> <summary>Generate a gnomAD VCF for Tumor Mutation Burden Calculation</summary>
