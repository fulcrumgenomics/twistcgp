...
### (Optionally) Pre-Generate a MSI Genome Scan List

Generation of the MSIsensor2 or MSIsensor-pro microsatellite scan list can be time intensive.
To save time you can supply the scan list generated by MSIsensor2 (or MSIsensor-pro) using the `--msisensor_scan` parameter.
