...
The pipeline will automatically use `tabix` to index the provided VCF if no index file is provided. The pipeline will automatically use `tabix` to index the provided VCF if no index file is provided.
